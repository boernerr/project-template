...
to_date(to_char(cast(c.datetransferredtoopr as date), 'dd-mon-yy')) as caseto_opr,
to_date(to_char(cast(c.adjudicationcomplete as date), 'dd-mon-yy')) as caseadjcomplete,
a.caseid
